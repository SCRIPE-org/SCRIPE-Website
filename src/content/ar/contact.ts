...
export const contactContent: ContactContent = {
  ...
  form: {
    ...
    footnote: "تهيئة بمرافقة فريق المبيعات · التشغيل عادةً خلال فترة توقف موسم واحدة.",
  },
  expect: {
    ...
    items: [
      {
        ...
        value: "لم يُنشر بعد",
        note: "استخدم النموذج — فهو يصل إلى الفريق نفسه.",
      },
      {
        id: "phone",
        label: "الهاتف",
        value: "لم يُنشر بعد",
        note: "اترك رقمك في النموذج وسنتصل بك.",
      },
      {
        id: "response",
        label: "الرد",
        value: "خلال يوم عمل واحد",
