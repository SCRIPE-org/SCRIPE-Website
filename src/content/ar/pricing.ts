...
export const pricingContent: PricingContent = {
  meta: {
    title: "الأسعار",
    description:
      "أسعار SCRIPE: خطط البداية والنمو والمؤسسات، تُفوتر شهريًا أو سنويًا وتُسعَّر على أساس الفروع والرياضات والحجم.",
  ...
  hero: {
    ...
    subtitle: "ثلاث خطط، تُفوتر شهريًا أو سنويًا.",
    primaryCta: "احجز عرضًا توضيحيًا",
    imageAlt:
      "لقطة جوية ليلية لمدينة تتوزع فيها أربعة مرافق رياضية مضاءة — كل منها ملعب أو مسبح أو مجموعة ملاعب خاصة به",
  },
  billing: {
  ...
  comparison: {
    ...
    caption: "النسخ التجريبية تُعدّ مع فريقنا لتُربط برامجك وملاعبك وطاقمك قبل أن تجربها.",
    includedLabel: "مشمول",
